...
6.  
`./semester.txt. -- permission denied`. 
7.  
`sh semester.txt -- show up`. 
(serached online: “sh” takes the following file as a parameter, and “./” takes the following file as an executable program）. 
8.  
`···man chmod`. 
9.  
`chmod +x semester.txt`. 
`./semester.txt`. 
